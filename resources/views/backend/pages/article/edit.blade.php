                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if ($article->image)
                                    <img src="{{ asset('storage/' . $article->image) }}" alt="Current Image" class="img-fluid mt-2" style="max-height: 100px;">
                                @endif
                                @error('image')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <!-- Input hidden untuk Trix Editor -->
                        ...
                        {{-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="published_at"
                                    ...
                                    value="{{ old('published_at', $article->published_at ? \Carbon\Carbon::parse($article->published_at)->format('Y-m-d') : '') }}">
                                @error('published_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
